"""Completed-run adapter for read-only G1 Fusion replay v3.

Historical completed-run loading remains in v1. This adapter changes only the in-memory candidate
policy and never executes providers or mutates Breakdown/Final rows.
"""
...
from engine.app import breakdown_g1_fusion_replay_v3 as candidate
