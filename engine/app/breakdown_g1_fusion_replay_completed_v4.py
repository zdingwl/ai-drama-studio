"""Completed-run adapter for read-only G1 Fusion replay v4.

Loads immutable completed sidecars, runs no providers and writes no Breakdown/Final rows.
"""
...
from engine.app import breakdown_g1_fusion_replay_v4 as candidate
