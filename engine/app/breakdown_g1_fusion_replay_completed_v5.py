"""Completed-run adapter for read-only G1 Fusion replay v5.

Loads immutable completed sidecars, executes no providers and writes no Breakdown/Final rows.
"""
...
from engine.app import breakdown_g1_fusion_replay_v5 as candidate
...
def replay_completed_run(run_id: str) -> dict[str, Any]:
    ...
    return {
        ...
        "policies": {
            ...
            "base_subject_continuity": candidate.BASE_SUBJECT_POLICY,
            "window_hint_resolution": candidate.WINDOW_HINT_RESOLUTION_POLICY,
            "compact_appearance": candidate.COMPACT_APPEARANCE_POLICY,
