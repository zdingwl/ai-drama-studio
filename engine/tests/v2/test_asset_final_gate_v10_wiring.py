...
def test_v10_resolver_is_accepted_by_formal_gate() -> None:
...
def test_formal_asset_profile_marks_v10() -> None:
    assert asset_analysis_progress_v4.FORMAL_ASSET_PROFILE_VERSION == "f05-assets-v10-person-evidence-model-classification"
    assert asset_analysis_progress_v4.FORMAL_CHARACTER_COMPONENT_PROFILE == "V10_PERSON_EVIDENCE_MODEL_CLASSIFICATION"
