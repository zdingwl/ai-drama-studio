...
.task-actions button { min-height: 38px; border: 1px solid #d3deed; border-radius: 9px; padding: 0 12px; background: #fff; color: #4f617c; cursor: pointer; font-size: 11px; font-weight: 800; white-space: nowrap; }
