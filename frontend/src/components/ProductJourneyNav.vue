...
function workspaceHref(id: WorkspaceId) {
  return `/projects/${String(route.params.id)}/${id}`
}
...
<template>
  <nav class="journey-nav" :class="{ replica: projectType === 'REPLICA' }" aria-label="项目制作流程">
    <section class="nav-group">
      ...
      <a class="utility-link" :class="{ active: activeId === 'episodes' }" :href="workspaceHref('episodes')" @click.prevent="openWorkspace('episodes')"><span aria-hidden="true">▣</span><strong>剧集管理</strong></a>
    </section>
