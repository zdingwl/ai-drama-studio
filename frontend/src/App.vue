...
import SourceConfirmOverlayV2 from './components/SourceConfirmOverlayV2.vue'
...
<template>
  ...
  <SourceConfirmOverlayV2 v-if="sourceConfirmProjectId" :project-id="sourceConfirmProjectId" />
</template>
