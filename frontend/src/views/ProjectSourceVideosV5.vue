  ...
  <div class="source-video-page" @keydown.esc="uploadOpen ? closeUpload() : closeDelete()">
    ...
    <div v-if="uploadOpen" class="backdrop" @click.self="closeUpload">
      <section class="modal upload-modal">
        ...
        <div :class="['drop-zone', { active: uploadDragging }]" @dragenter.prevent="uploadDragging = true" @dragover.prevent="uploadDragging = true" @dragleave.prevent="uploadDragging = false" @drop="handleDrop" @click="selectFiles">
          ...
          <div class="cloud">⇧</div><strong>拖拽视频到这里，或点击选择</strong><span>支持 mp4 / mov / mkv，可一次选择多个视频</span><button class="primary" type="button" tabindex="-1">选择视频</button>
        </div>
