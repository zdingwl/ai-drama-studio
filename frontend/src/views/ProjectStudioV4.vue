    ...
    <section class="workspace">
      ...
      <main v-if="activeView === 'project'" class="panel">
        ...
        <section class="auto-run">
          <div><small>自动流程</small><strong>能自动完成的全部在后台完成</strong><p>素材 → 镜头 → ASR/OCR/VLM → 原片资产 → SourceDramaSnapshot → 目标人物/场景 → 目标对白/TTS → Timing → H3 GenerationSegment。只有异常进入待确认。</p></div>
