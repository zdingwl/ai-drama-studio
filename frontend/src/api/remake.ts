...
export const remakeApi = {
  ...
  retryLipSyncReview: (projectId: string, segmentId: string) => request<PostProductionSegment>(`/api/projects/${projectId}/postproduction-segments/${segmentId}/retry-lip-sync`, { method: 'POST' }),
