...
class SourceBibleRevision(Base):
    __tablename__ = "source_bible_revisions"
    ...
    shot_anchors_artifact_id: Mapped[str | None] = mapped_column(ForeignKey("artifact_nodes.id", ondelete="SET NULL"), nullable=True, index=True)
    generated_by_task_id: Mapped[str | None] = mapped_column(ForeignKey("tasks.id", ondelete="SET NULL"), nullable=True, index=True)
    edit_parent_artifact_id: Mapped[str | None] = mapped_column(ForeignKey("artifact_nodes.id", ondelete="SET NULL"), nullable=True, index=True)
