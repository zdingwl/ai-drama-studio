from app.skills.models import Capability, CapabilityDefinition


CAPABILITIES: tuple[CapabilityDefinition, ...] = (
    CapabilityDefinition(id=Capability.SOURCE_VIDEO_INGEST, title="原片导入", description="接收并登记视频来源素材。", category="input"),
    CapabilityDefinition(id=Capability.SOURCE_TEXT_INGEST, title="文本导入", description="接收小说或剧本等文本来源素材。", category="input"),
    CapabilityDefinition(id=Capability.MEDIA_PREFLIGHT, title="媒体检查", description="检查视频可解码性、时间基准和基础媒体信息。", category="source"),
    CapabilityDefinition(id=Capability.SHOT_BOUNDARY, title="镜头边界", description="建立原片切镜时间锚点，不承担剧情理解。", category="source"),
