...
CAPABILITIES: tuple[CapabilityDefinition, ...] = (
    ...
    CapabilityDefinition(id=Capability.TARGET_ASSETS, title="目标资产", description="生成并管理目标人物、场景和关键道具资产。", category="target", availability=CapabilityAvailability.AVAILABLE),
    CapabilityDefinition(id=Capability.STORYBOARD_LOCALIZATION, title="分镜本土化", description="把正式原片分镜逐镜改写为中文可审计描述、目标语言对白和中文对白翻译。", category="target"),
    CapabilityDefinition(id=Capability.ASSET_IMAGE_GENERATION, title="资产图生成", description="从本土化分镜提取人物、场景、道具并生成真实可引用资产图。", category="target"),
    CapabilityDefinition(id=Capability.MODEL_PROMPTING, title="模型专属提示词", description="按目标视频模型的 Professional Skill 编译模型原生提示词和参考条件。", category="generation"),
